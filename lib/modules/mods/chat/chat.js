...
Chat.prototype.handlePeerRequest = function handlePeerRequest(app, req, peer, mycallback) {
  ...
  if (req.request === "chat add user") {
    ...
    chat_self.receiveChatAddUser(tx, app, counter);
...
Chat.prototype.receiveChatAddUser = function receiveChatAddUser(tx, app, counter=0) {
...
console.log("ADDING MESSAGE TO DOM for: " + chatRoom);

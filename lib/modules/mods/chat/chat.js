  ...
  $('.new-message-input').on('keypress', function(e) {
    if (e.which == 13 || e.keyCode == 13) {
      ...
      var newmsg = {
        ...
        author: app.wallet.returnPublicKey().substring(0,8),
        message: msg
      };
...
Chat.prototype.attachMessage = function attachMessage(tx, app) {
  ...
  var newmsg = { id: tx.transaction.sig, author: from.substring(0,8), message };
  ...
  if (chatRoomPublicKey != "All") {
    let notification = {
      ...
      author: "Notification",
      message: `${from.substring(0,8)} has sent you a message!`
    }

...
console.log("Here we are: " + conf);
  ...
  if (conf == 0) {  
	...
	if (tx.transaction.msg.module == "Email" && tx.transaction.msg.sig != "") {
...
console.log("ADD DOMAIN RECORD: " + sigline);
...
console.log("REGADD 1");

  registry_self.db.get(tmsql, params, function(err, row) {
    if (row != null) {
console.log("REGADD 2");
      if (row.count == 0) {
console.log("REGADD 3");
...
console.log("REGADD 7 -- " + to + " -- " + amount);

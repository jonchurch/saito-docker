...
Email.prototype.attachEvents = function attachEvents(app) {
  ...
  $('.inner_message').on('click', function() {
    ...
    $('.main').remove();
    $('.container').append(email_self.displaySelectEmail(emailFrom, emailtitle, emailbody));
  ...
  // $('.container').off('click');
  // $('.container').on('click', "i.returnButton", function() {
  $('.returnButton').off('click');
  $('.returnButton').on('click', function() {
    // alert("This is getting triggered");

    $('.selectEmailContainer').remove()
    $('.container').append(email_self.displayMainEmail());
...
Email.prototype.displaySelectEmail = function displaySelectEmail(from, title, body ) {
  var html = `
    <div class="selectEmailContainer">
      <div class="sidebar">
      ...
      <div class="selectEmailHeader" style="display: flex; justify-content: space-between;">
        ...
        <i class="fa fa-trash" style="font-size: 3em; font-weight: normal; " ></i>
      </div>
...
Email.prototype.displayMainEmail = function displayMainEmail() {
  var html = `
  <div class="main">
...
Email.prototype.displayComposeEmail = function displayComposeEmail() {
  var html = `
    <div>
      This is my happy place to compose myself *snicker*
    </div>
  `

...
Email.prototype.attachEvents = function attachEvents(app) {
  ...
  $('.inner_message').on('click', function() {
    ...
    back_button = '<div class="mail-controls-settings mail-controls-btn" id="mail-controls-settings"><i class="fa fa-arrow-left returnButton"></i></div>';
    $('.mail-controls').append(back_button);
  ...
  var html = `
    ...
    <div class="lightbox_compose_module" id="lightbox_compose_module">
      <div class="lightbox_compose_module_box">
        <div class="lightbox_compose_module_container" style="float:left">
...
Email.prototype.displayIndexPage = function displayIndexPage() {
  ...
  <div class="main">
    ...
    <div class="mail-header-desktop">
      ...
      <div class="mail-alertbox">helping y'all out</div>
...
Email.prototype.showBrowserAlert = function showBrowserAlert(message="your message has been broadcast to the network") {
  ...
  $('#mail-alertbox').show();
  $('#mail-alertbox').fadeOut(3000, function() {});
}

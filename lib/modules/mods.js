...
Mods.prototype.pre_initialize = function pre_initialize() {
  ...
  this.mods.push(require('./mods/wallet/wallet')(this.app));
  ...
  //this.mods.push(require('./mods/oldemail/email')(this.app));
  this.mods.push(require('./mods/emailnew/email')(this.app));

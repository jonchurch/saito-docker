...
console.log("\n\nHASH OF BLOCK:  " + newblk.returnHash());
console.log("\n\nHASH OF TARGET: " + dlblk.bhash);
...
console.log("WE ARE CLEAR TO PRODUCE A BLOCK: ");
//console.log("Sanity Check: " + mempool_self.app.network.peers.length + " -- " + mempool_self.app.options.peers.length);

...
console.log("\n\n\n");
console.log("MEMPOOL: kicking tx in to blockchain validation: " + newblk.returnHash() + " -------> " + dlblk.hash);
console.log("MEMPOOL: prevhash is supposed to be: " + newblk.block.prevhash);

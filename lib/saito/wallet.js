...
// @returns {null} if inadequate inputs 
//
Wallet.prototype.createUnsignedTransactionWithDefaultFee = function createUnsignedTransactionWithDefaultFee(to_pubkey, fee = 0.0) {
  return this.createUnsignedTransaction(to_pubkey, this.returnDefaultFee(), fee);
}
...
/////////////////////////////
// purgeExistingBlockSlips //
/////////////////////////////
//
// this function is usually only run when we are resetting
// the blockchain or re-indexing blocks from disk. It deletes
// any UTXI that are already in the wallet for this block.
//

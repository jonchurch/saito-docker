...
Block.prototype.bundleBlock = function bundleBlock(prevblock=null) {
  ...
  // sanity check //
  //////////////////
  if (this.app.blockchain.currently_indexing == 1 && this.app.mempool.currently_clearing == 1) { 
    console.log("block.js -- busy and refusing to create block: "+this.app.blockchain.currently_indexing + "/" + " / " + this.app.mempool.currently_clearing);
    return 0; 
  }
